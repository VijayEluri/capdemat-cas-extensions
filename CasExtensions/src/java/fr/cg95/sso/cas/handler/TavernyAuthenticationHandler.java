...
public class TavernyAuthenticationHandler implements AuthenticationHandler {

    private static Logger log =
        Logger.getLogger(TavernyAuthenticationHandler.class);
    ...
    public boolean authenticate(Credentials credentials) throws AuthenticationException {
        ...
        while (m.find()) {
            String g = m.group(1);
            if (g != null && !g.isEmpty() && !g.equals("users")) {
                credentialsBuffer.append(";group=").append(g);
            }
        }
